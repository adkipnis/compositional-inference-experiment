...
testTrials$map_0 = NULL
testTrials$map_1 = NULL
...
dualTrialsClean = merge(dualTrials, limits, by = "id") %>%
  filter(rt >= lower, rt <= upper) %>% na.omit()
...
(2) compositionality: RT for double spells based on average from used primitives vs other, maybe incorporate trial number as IE
-->
```
