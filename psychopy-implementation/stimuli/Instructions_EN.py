...
PrimitivesMEGR = [0,
              ...
              "Use the following keys:",
              1,
              "If you don't know the answer, please press the (red) 'next' key rather than guessing.",
              "You will not receive any feedback per trial,\nbut you will get a final score.",
              "You need to get at least 90% of all trials right -\nif you fail, you will immediately restart this part of the exam.",
              "Remember to move as little as possible for the helmet.",
              "Ready to begin the exam?"]
